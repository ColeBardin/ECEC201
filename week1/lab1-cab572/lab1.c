 ...
 *
 * STEP 5
 *  If you are on an online IDE download your files as a zip,
 *  otherwise zip your files through the terminal using the zip command
 *
 * STEP 6
 *  Make sure it is named 'lab1-abc123.zip'
 *
...
int main()
{
    ...
    printf("My name is Cole Bardin.\nI like the Halal trucks by Drexel!\n");
